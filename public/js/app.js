    ...
    [
      _vm._l(_vm.events, function(event, $index) {
        return _c(
          ...
          {
            key: $index,
            staticClass: "bg-gray-100 lg:p-2 lg:p-10 mb-2 shadow-sm rounded-lg"
          },
          [
            _c(
              "div",
              {
                staticClass:
                  "text-4xl leading-6 p-2 font-medium text-gray-900 lg:flex lg:justify-between"
              },
              [
                _c("h1", { staticClass: "font-serif" }, [
                  _vm._v(_vm._s(event.title))
                ]),
                _vm._v(" "),
                _c(
                  "p",
                  { staticClass: "text-sm text-right lg:left text-gray-700" },
                  [_vm._v(_vm._s(event.date))]
                )
              ]
            ),
            _vm._v(" "),
            _c("p", { staticClass: "text-gray-700 lg:mt-3 ml-5" }, [
              _c("span", { staticClass: "w-1/2 lg:w-0" }, [
                _vm._v("Location:")
              ]),
            ...
            event.videos
              ? _c(
                  "div",
                  {
                    staticClass: "lg:mt-2 flex flex-col sm:flex-row flex-wrap"
                  },
                  _vm._l(event.videos, function(video) {
                    return _c(
                      "div",
                      {
                        staticClass:
                          "flex flex-col sm:w-1/3 rounded-lg hover:bg-white"
                      },
                      [
                        _c("div", { staticClass: "lg:m-3 mb-3" }, [
                          _c(
                            "a",
                            {
                              attrs: {
                            ...
                            [
                              _vm._l(video.thumbnails, function(thumbnail) {
                                return thumbnail.size == "high"
                                  ? _c("div", [
                                      _c("img", {
                                        attrs: {
                                          loading: "lazy",
                              ...
                              _c(
                                "div",
                                { staticClass: "pl-2 justify-between" },
                                [
                                  _c("div", [
                                    _c(
                                      "div",
                                      {
                                        staticClass:
                                          "text-lg leading-6 font-medium flex justify-between"
                                      },
                                      [_c("h1", [_vm._v(_vm._s(video.title))])]
                                    )
                                  ]),
                                  _vm._v(" "),
                                  _c(
                                    ...
                                    [
                                      _c("p", [
                                        _vm._v(_vm._s(video.views) + " Views")
                                      ])
                                    ]
                                  )
                                ]
        ...
        _c(
          ...
          [
            _c(
              "svg",
              {
                staticClass: "animate-spin -ml-1 mr-3 h-10 w-10 text-white",
                attrs: {
...
Vue.use(vue_infinite_loading__WEBPACK_IMPORTED_MODULE_0___default.a);
...
__webpack_require__(/*! /home/stijn/Documents/projects/laravel/whereiscl/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/stijn/Documents/projects/laravel/whereiscl/resources/css/app.css */"./resources/css/app.css");
